...
const LoadingView: React.FC = () => {
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-background-light dark:bg-background-dark transition-colors duration-500">
      ...
      <div className="mt-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Welcome to EduVault</h1>
        <p className="mt-2 text-slate-500 dark:text-slate-400 font-medium">Your personal academic archive...</p>
      </div>
    </div>
  );
};

        ...
        <>
          ...
          <div className="flex items-center gap-1 relative">
            ...
            <button 
              ...
              className="sm:hidden p-2 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors"
            >
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-3 w-72 bg-white dark:bg-[#1a2632] rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 p-5">
                  <div className="flex flex-col items-center text-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 dark:text-white">Student Account</h4>
                      <p className="text-[11px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">ID: SV-2024-9182</p>
                    </div>
                    <div className="w-full bg-primary/5 dark:bg-primary/10 p-4 rounded-xl border border-primary/10">
                      <p className="text-[10px] text-primary uppercase font-black tracking-widest mb-2">Quote of the Day</p>
                      <p className="text-[13px] text-slate-700 dark:text-slate-300 italic font-medium leading-relaxed">
                        "{dailyQuote}"
                      </p>
                    </div>
                    <button className="w-full py-2.5 bg-slate-50 dark:bg-slate-800 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-100 transition-colors">
                      Settings
                    </button>
                  </div>
                </div>
